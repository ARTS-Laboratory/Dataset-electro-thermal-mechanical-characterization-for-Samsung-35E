...
<Library LVVersion="13008000">
	...
	<Item Name="Add Actions to Stack.vi" Type="VI" URL="../Add Actions to Stack.vi"/>
	<Item Name="Next Action Core.vi" Type="VI" URL="../Next Action Core.vi">
		<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
	</Item>
	<Item Name="Next Action.vi" Type="VI" URL="../Next Action.vi"/>
</Library>
