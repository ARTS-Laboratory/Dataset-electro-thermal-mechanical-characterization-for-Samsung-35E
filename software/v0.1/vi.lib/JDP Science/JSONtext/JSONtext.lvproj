...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Config Files" Type="Folder">
			<Item Name="Config File.lvclass" Type="LVClass" URL="../Config Files/Config File.lvclass"/>
			<Item Name="Config Tester 2.vi" Type="VI" URL="../Tests/Config Tester 2.vi"/>
			<Item Name="Config Tester App 1.vi" Type="VI" URL="../Tests/Config Tester App 1.vi"/>
			<Item Name="Config Tester App 2.vi" Type="VI" URL="../Tests/Config Tester App 2.vi"/>
			<Item Name="Config Tester.vi" Type="VI" URL="../Tests/Config Tester.vi"/>
		</Item>
		<Item Name="Tests" Type="Folder">
			...
			<Item Name="Strings.vi" Type="VI" URL="../support/Strings.vi"/>
			<Item Name="Permisive Commas.vi" Type="VI" URL="../Tests/Permisive Commas.vi"/>
			<Item Name="Pretty Print Speed Test.vi" Type="VI" URL="../Tests/Pretty Print Speed Test.vi"/>
			<Item Name="Pretty Print Methods Test.vi" Type="VI" URL="../Tests/Pretty Print Methods Test.vi"/>
			<Item Name="Integer and Enum Type match on Flattening.vi" Type="VI" URL="../Tests/Integer and Enum Type match on Flattening.vi"/>
			<Item Name="Test Parallel Config File Writes.vi" Type="VI" URL="../Tests/Test Parallel Config File Writes.vi"/>
		</Item>
		...
		<Item Name="Probes" Type="Folder">
			...
			<Item Name="JSONtext Pretty Print (Colour).vi" Type="VI" URL="../Probes/JSONtext Pretty Print (Colour).vi"/>
		</Item>
		...
		<Item Name="TEST Variant to Flattened String (special).vi" Type="VI" URL="../Exclude from VIPM/Test/TEST Variant to Flattened String (special).vi"/>
		<Item Name="test Variant.vi" Type="VI" URL="../Exclude from VIPM/Test/test Variant.vi"/>
